...
if __name__ == "__main__":
    ...
    # source_directory = "../data/preprocess_data/prepare_calculation_Database_split_10/set_10"
    # output_archive = "../data/preprocess_data/prepare_calculation_Database_split_10/set_10.tar.gz"
